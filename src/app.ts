...
const BUSINESS_NAME = "کلینیک";
const WELCOME_MESSAGE = "خوش آمد";
const SUPPORT_CONTACT: string = "@mrh3d";
const TEMPLATE_CODE: string = "COURSE_FILE";
const TEMPLATE_TITLE = "فروش دوره / فایل";
const DETAILS_RAW = "فروش قطعی دوره";
const DETAIL_LINES = [
  "فروش قطعی دوره"
];
const FEATURES = [
